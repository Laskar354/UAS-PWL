...
if(isset($_POST["tambah_quis"])){

    //cek apakah data berhasil diinputkan
    if( tambah_quis($_POST) > 0 ){
        echo "<script>
                    alert('Data Quis berhasil ditambahkan');
                    document.location.href='mq.php';
            </script>";
    }else{
        echo "<script>
                    alert('Data Quis gagal ditambahkan');
                    document.location.href='mq.php';
            </script>";
        echo "<br>";
            ...
            <div class="row mt-5">
                <div class="col-sm-12">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input name="judul_quis" type="text" class="form-control" placeholder="contoh : Sistem Tata Surya" required aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                    </div>
                    <div class="input-group input-group-sm mb-3">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <button class="btn btn-dark" type="submit" name="tambah_quis">Tambah Quis</button>
                    </div>
                </div>
            </div>
            </form>
