...
$transaksi = data("SELECT transaksi.*, user.* FROM transaksi INNER JOIN user ON transaksi.id_user = user.id_user");
            ...
            <div class="row mt-5">
                <div class="col-sm-12">
                    <table class="table table-success table-striped" border="2" cellpadding="30" cellspacing="0">
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $tsk['username']; ?></td>
                            <td><?php echo $tsk['tgl_bayar']; ?></td>
                            <td><?php echo $tsk['harga'] ?></td>
                            <td><img src="../bukti_transaksi/<?php echo $tsk['bukti'] ?>" alt="" width="50px"></td>
                            <td><?php echo $tsk['sampai_tgl'] ?></td>
                        </tr>
