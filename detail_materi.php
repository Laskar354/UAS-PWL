...
$mtr = data("SELECT nama_materi, video, isi FROM materi WHERE id_materi = $id_materi AND $id_mapel")['0'];
...
<body class="bodyhome">
    ...
    <section>
        <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
            <div class="row">
                <div class="judul col-sm-12 ratio ratio-16x9 mt-5">
                    <iframe src="<?php echo $mtr['video']; ?>" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </section>
