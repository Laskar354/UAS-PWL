            ...
            <div class="card-body align-content-lg-center mt-5">
                ...
                <div class="row">
                    <div class="col-sm-12 mb-4">
                        <input type="text" name="username" class="form-control" id="name" placeholder="Masukkan username" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required />
                    </div>
                    <div class="col-sm-12 mb-4">
                        <input type="email" name="email" class="form-control" id="name" placeholder="Masukkan Email" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required />
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-12 mt-5">
                        <div class="d-grid gap-1">
                            <button class="btn btn-success rounded-pill" name="daftar" type="submit">Daftar</button>
                        </div>
                    </div>
                    <div class="col-sm-12 mt-2">
                        <div class="d-grid">
                            <a href="login.php" class="btn btn-outline-success rounded-pill">Login</a>
                        </div>
                    </div>
                </form>
                </div>
